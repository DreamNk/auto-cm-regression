...
public class Password_Check_Test extends AbstractAutoUITest {

	String  username = null ;
	static String Password = null;
	String filePath = "D:\\CMAutoWorkspace\\auto-cm-regression\\GetPasswordStaging.xlsx";  
	
	String fileName = "GetPasswordStaging.xlsx";
	String userId[]={"repone@raymond.vm","v2@gps.net","carol.lopez@egxv411.vm","repone@aurora.vm","rayan@gps.com","dom@pg.com",
	...
	@Test
	 public void CheckPasswordForAllUser() throws Exception  {
