...
public class Kiosk_Login_Test  extends AbstractAutoUITest{
	...
	public void Login_With_Invalid_Username(int rowNo, ExcelRow row){
	 ...
	 @DataProvider (name="DP1")
		  ...
		  Object[][] data = getExcelClient("EXCEL_KIOSK_LOGIN").get_multiple_rows(2, 3);
		  return data;
}
	...
	public void Login_With_Invalid_PasswordOrInactiveRM(int rowNo, ExcelRow row){
	 ...
	 @DataProvider (name="DP2")
		  ...
		  Object[][] data = getExcelClient("EXCEL_KIOSK_LOGIN").get_multiple_rows(6, 8);
		  return data;
}
	 ...
	 @Test(priority=3, groups = "functional",  dataProvider = "DP3")                                         
		public void Login_With_Valid_Buyer_Credential(int rowNo, ExcelRow row){
		 ...
		 @DataProvider (name="DP3")
			  ...
			  Object[][] data = getExcelClient("EXCEL_KIOSK_LOGIN").get_multiple_rows(12, 14);
			  return data;
}
		...
		@DataProvider (name="DP4")
				  ...
				  Object[][] data = getExcelClient("EXCEL_KIOSK_LOGIN").get_multiple_rows(19, 19);
				  return data;
}
		...
		@DataProvider (name="DP5")
					  ...
					  Object[][] data = getExcelClient("EXCEL_KIOSK_LOGIN").get_multiple_rows(20, 20);
					  return data;
}		 
